        ...
        <div id="contact" className="px-4">
          ...
          <div className="mb-16 md:mb-24">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 justify-center mx-auto max-w-4xl">
              ...
              <Link
                className="flex items-center text-white dark:text-white justify-center bg-[#172554] hover:bg-[#2c4598] w-full h-14 font-semibold transition delay-150 duration-200 hover:-translate-y-1 hover:scale-110 rounded-lg"
                target="_blank"
              ...
              <Link
                className="flex items-center text-white dark:text-white justify-center bg-blue-800 hover:bg-blue-700 w-full h-14 font-semibold transition delay-150 duration-200 hover:-translate-y-1 hover:scale-110 rounded-lg"
                target="_blank"
              ...
              <Link
                className="flex items-center text-white dark:text-white justify-center bg-[#270767] hover:bg-[#311d59fc] w-full h-14 font-semibold transition delay-150 duration-200 hover:-translate-y-1 hover:scale-110 rounded-lg"
                target="_blank"
          ...
          <div className="mb-16">
            ...
            <div className="flex flex-col gap-5 sm:flex-row justify-center items-center mx-auto max-w-3xl">
              ...
              >
                ...
                <p className="font-extralight text-white dark:text-white tracking-wide text-sm mt-2">
